export default function Hero() {
  return (
    <section className="relative w-full h-[300px] sm:h-[360px] md:h-[420px] flex items-center justify-center overflow-hidden">
      {/* Background Image */}
      <img
  ...
  HELP Ethiopia
        ...
        <p className="text-white/95 text-base sm:text-lg md:text-xl font-medium leading-relaxed drop-shadow-xl">
